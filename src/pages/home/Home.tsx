...
export default function Home() {
  ...
  const {
    ...
    page,
    size: PAGE_SIZE,
    moderationStatus: selectedModerationStatus || undefined,
    reportStatus: selectedStatus || undefined,
    category: selectedCategory || undefined,
    enabled: isAdmin,
  });
  ...
  useEffect(() => {
    setPage(1);
  }, [selectedCategory, selectedStatus, selectedModerationStatus]);
    ...
    <div className="min-h-screen flex flex-col items-center justify-start bg-gray-50">
      ...
      <Grow in timeout={1000}>
        <div className="container my-10 flex flex-col gap-5 max-lg:px-5">
          ...
          {!hasActiveFilters && sourceReports.length > 0 && (
            <PaginationControls
              page={page}
